...
/*
  ...
  flickers. Base art is `parker-logo-mesh.webp` (640x640, includes the full
  glyph + ball + "PARKER" wordmark on a near-black background); we crop to the
  ...
  Crop box (fraction of the full image): x 0.194–0.871, y 0.092–0.769.
*/

const CROP_FRAC = 0.677
const OFFSET_X_FRAC = 0.194
const OFFSET_Y_FRAC = 0.092
  ...
  useEffect(() => {
    ...
    function frame() {
      ...
      for (const n of nodes) {
        ...
        if (a < 0.02) continue
        const x = n.x * W; const y = n.y * H; const R = n.r * W + 5 + tw * 3 + n.heat * 9
      ...
      for (let p = pulses.length - 1; p >= 0; p--) {
        ...
        g.beginPath(); g.arc(px, py, 1.3, 0, 7); g.fill()
      }
